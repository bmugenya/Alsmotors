...
class App extends Component {  
  ...
  constructor(props) {
    super(props);
    this.urls = { get:`https://alsmotors.onrender.com/vehicles/api`};
 ...
 const items = item_model(currentPosts)
  ...
  return html`${this.state.ready && html`
    <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n7" style="padding:0 !important;">
      <div class="container">
        <form role="form" method="post" onSubmit=${searchVeh}>
        <div class="row">
          ...
          <div class="col-lg-6 text-end d-flex justify-content-center">
            <button type="button" class="btn btn-outline-warning  ms-lg-1 me-lg-0 me-auto mt-lg-0 mt-2">AL Siddique Motors</button>
          </div>
        </div>
      <div class="row">
